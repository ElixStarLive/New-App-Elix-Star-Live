...
export default function FollowingFeed() {
  ...
  return (
    <div className="app-live-column relative h-full w-full">
      <FeedStoryCirclesOverlay title="Following" onSearch={goSearch} onBack={goBack} />
        ...
        >
          ...
          {!loading && videos.length === 0 && (
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 text-center">
              <p className="elix-silver-red-text font-semibold text-base mb-1">No videos from people you follow</p>
              <p className="elix-silver-red-text text-sm opacity-60 mb-4">Follow people to see their videos here.</p>
              <button
                type="button"
                onClick={goDiscover}
                className="rounded-full border border-[#D8D9DD]/40 bg-transparent px-5 py-2 text-sm font-bold text-[#F5F5F7]"
              >
                Discover people
              </button>
            </div>
