...
const withdrawalApi = vi.hoisted(() => ({
  list: {
    data: [
      ...
      },
      {
        ...
        display_name: "Creator Two With A Very Long Display Name That Must Wrap",
        amount_pence: 123456789,
        currency: "GBP" as const,
        status: "approved",
        admin_note: "ref-1",
        processed_by: "admin-1",
        processed_at: "2026-08-22T01:00:00.000Z",
  ...
  action: {
    ...
    withdrawal: {
      ...
      admin_note: null,
      processed_by: "admin-1",
      processed_at: "2026-08-22T02:00:00.000Z",
      created_at: "2026-08-22T00:00:00.000Z",
    },
    error: null as string | null,
  },
