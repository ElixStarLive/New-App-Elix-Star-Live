-- Legacy videos may exist without baseline columns (CREATE IF NOT EXISTS no-op).
ALTER TABLE videos ADD COLUMN IF NOT EXISTS bunny_path TEXT;
ALTER TABLE videos ADD COLUMN IF NOT EXISTS thumbnail_url TEXT;
ALTER TABLE videos ADD COLUMN IF NOT EXISTS caption TEXT NOT NULL DEFAULT '';
ALTER TABLE videos ADD COLUMN IF NOT EXISTS hashtags TEXT[] NOT NULL DEFAULT '{}';
ALTER TABLE videos ADD COLUMN IF NOT EXISTS duration_ms INTEGER NOT NULL DEFAULT 0;
ALTER TABLE videos ADD COLUMN IF NOT EXISTS is_stem BOOLEAN NOT NULL DEFAULT FALSE;
