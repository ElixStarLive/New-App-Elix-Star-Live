ALTER TABLE shop_items ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMPTZ;
ALTER TABLE shop_items ADD COLUMN IF NOT EXISTS title TEXT NOT NULL DEFAULT '';
ALTER TABLE shop_items ADD COLUMN IF NOT EXISTS price_pence INTEGER NOT NULL DEFAULT 0;
