...
P(`### PAGE-020 Live profile overlay
- **Route:** \`/watch/:streamId/profile/:userId\`.
- **OLD visual authority:** profile overlay used by spectator shell (not the Follow-on-Join capsule; not Profile.tsx page).
...
P(`### PAGE-029 Creator login details
...
P(`### PAGE-031 Inbox Activity overlay
...
P(`### PAGE-035 Incoming call modal
...
P(`### PAGE-043 Notification settings
...
P(`### PAGE-056 Rising Stars challenge
...
- **What happens:** Readable legal document. Named back. Linked from Register/Settings. No ticket API.
- **Parity tests:** renders; back.`);

P(`### PAGE-058 Privacy — \`/privacy\` \`Privacy.tsx\`. Same as 057 (document + named back).`);
P(`### PAGE-059 Copyright — \`/copyright\` \`Copyright.tsx\`. Document; copyright report tables exist for FLOW-031.`);
P(`### PAGE-060 Legal hub — \`/legal\` \`Legal.tsx\`. Links to legal children.`);
P(`### PAGE-061 Legal audio — \`/legal/audio\` \`LegalAudio.tsx\`.`);
P(`### PAGE-062 Legal UGC — \`/legal/ugc\` \`LegalUGC.tsx\`.`);
P(`### PAGE-063 Legal affiliate — \`/legal/affiliate\` \`LegalAffiliate.tsx\`.`);
P(`### PAGE-064 Legal DMCA — \`/legal/dmca\` \`LegalDMCA.tsx\`.`);
P(`### PAGE-065 Legal safety — \`/legal/safety\` \`LegalSafety.tsx\`.`);
P(`### PAGE-066 Legal supplier — \`/legal/supplier\` \`LegalSupplier.tsx\`.`);
P(`### PAGE-067 Guidelines — \`/guidelines\` \`Guidelines.tsx\`.`);
P(`### PAGE-068 How it works — \`/how-it-works\` \`HowItWorks.tsx\`.`);
P(`### PAGE-069 Support — \`/support\` \`Support.tsx\`. Content page; no fake ticket submit unless the OLD file posts (it is content).`);

P(`### PAGE-070 Admin dashboard
...
const header = `# OLD production master specification (frozen)
...
fs.writeFileSync(
  "C:/Users/Absm Construction/Desktop/New App Elix Star Live/docs/OLD-REBUILD-LEDGER.md",
  out,
);
console.log("master ledger bytes", out.length, "pages", pages.length);
